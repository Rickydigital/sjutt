 ...
 public function store(Request $request)
{
    ...
    // THIS IS THE KEY: Runs in background AFTER response is sent
    SendNewsNotificationJob::dispatch($news, $imageUrl)->afterResponse();

    return redirect()->route('news.index')
        ->with('success', 'News posted successfully! Students are being notified...');
}
