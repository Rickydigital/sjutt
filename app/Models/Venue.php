...
class Venue extends Model
{
    ...
    /**
     * Get examination timetables for this venue (many-to-many)
     */
    public function examinationTimetables(): BelongsToMany
    {
        return $this->belongsToMany(ExaminationTimetable::class, 'examination_timetable_venue')
                    ->withPivot('allocated_capacity')
                    ->withTimestamps();
    }

    /**
     * Get supervisors assigned to this venue for exams
     */
    public function examinationSupervisors(): BelongsToMany
    {
        return $this->belongsToMany(User::class, 'examination_timetable_supervisor')
                    ->withPivot('examination_timetable_id', 'supervisor_role')
                    ->withTimestamps();
    }
