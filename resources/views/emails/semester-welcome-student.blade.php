...
<head>
    ...
    <title>Welcome to New Semester - SJUT</title>
    <style>
                ...
                <table class="main-table" width="600" border="0" cellpadding="0" cellspacing="0" 
                    ...
                    <tr>
                        <td style="padding:50px 40px; text-align:center;">
                            <h2 style="color:#582B86; margin:0 0 25px; font-size:32px;">
                                Welcome Back, {{ $student->first_name }}!
                            </h2>
                            
                            <p style="font-size:18px; color:#444; line-height:1.8; margin-bottom:35px;">
                                We are excited to welcome you to the new semester at St John's University of Tanzania.
                            </p>
                            ...
                            <div style="background:#f8f9fa; padding:35px; border-radius:16px; margin:30px 0; text-align:left;">
                                <p style="font-size:17px; line-height:1.8; color:#333;">
                                    A new semester brings new opportunities, new achievements, and new growth.<br><br>
                                    Stay focused, attend your classes on time, work hard, and believe in yourself.<br><br>
                                    We wish you a peaceful, productive, and highly successful semester ahead.
                                </p>
                            </div>

                            <p style="color:#582B86; font-size:19px; font-weight:600; margin:35px 0;">
                                You’ve got this! 🚀
                            </p>
                        </td>
                    </tr>
