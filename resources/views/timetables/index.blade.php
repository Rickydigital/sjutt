...
@section('content')
    <div class="container">
                                                                ...
                                                                @if ($timetable)
                                                                    ...
                                                                    <div class="d-flex justify-content-center flex-nowrap">
                                                                        ...
                                                                        <a href="#" class="action-icon edit-exam"
                                                                            ...
                                                                            data-lecturer-ids="{{ json_encode($timetable->lecturers->pluck('id')->toArray()) }}"
                                                                            data-bs-toggle="tooltip"
                                                                            data-bs-placement="top" title="Edit Exam">
                                                                            <i
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control select2" id="academic_year" name="academic_year"
                                        ...
                                        @foreach ($academicYears as $year)
                                            <option value="{{ $year }}"
                                                {{ $year == '2024/2025' ? 'selected' : '' }}>{{ $year }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="programs" class="form-label">Programs <span
                                            class="text-danger">*</span></label>
                                    <select class="form-control select2" id="programs" name="programs[]" multiple
                                        required>
                                    ...
                                    <div id="timeSlots">
                                        <div class="time-slot mb-2">
                                            ...
                                            <input type="time" class="form-control mb-1"
                                                name="time_slots[0][start_time]" required>
        ...
        <!-- Edit Setup Modal -->
        @if ($setup)
            <div class="modal fade" id="editSetupModal" tabindex="-1" aria-labelledby="editSetupModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <form id="editSetupForm" action="{{ route('timetables.updateSetup', $setup->id) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="modal-header">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="edit_type" class="form-label">Program Types <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control select2" id="edit_type" name="type[]" multiple
                                            required>
                                            <option value="Degree"
                                                {{ in_array('Degree', $setup->type) ? 'selected' : '' }}>Degree</option>
                                            <option value="Non Degree"
                                                {{ in_array('Non Degree', $setup->type) ? 'selected' : '' }}>Non Degree
                                            </option>
                                            <option value="Masters"
                                                {{ in_array('Masters', $setup->type) ? 'selected' : '' }}>Masters</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control select2" id="edit_academic_year" name="academic_year"
                                            ...
                                            @foreach ($academicYears as $year)
                                                <option value="{{ $year }}"
                                                    {{ $year == $setup->academic_year ? 'selected' : '' }}>
                                                    {{ $year }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control select2" id="edit_semester" name="semester" required>
                                            @foreach ($semesters as $sem)
                                                <option value="{{ $sem }}"
                                                    {{ $sem == $setup->semester ? 'selected' : '' }}>{{ $sem }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="date" class="form-control" id="edit_start_date"
                                            name="start_date" value="{{ $setup->start_date }}" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="edit_programs" class="form-label">Programs <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control select2" id="edit_programs" name="programs[]"
                                            multiple required>
                                            @foreach ($allPrograms as $program)
                                                <option value="{{ $program->id }}"
                                                    {{ in_array($program->id, $setup->programs) ? 'selected' : '' }}>
                                                    {{ $program->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                            ...
                                            @foreach ($setup->time_slots as $index => $slot)
                                                <div class="time-slot mb-2">
                                                    <input type="text" class="form-control mb-1"
                                                        ...
                                                        value="{{ $slot['name'] }}" placeholder="Slot Name" required>
                                                    <input type="time" class="form-control mb-1"
                                        ...
                                        <button type="button" class="btn btn-primary mt-2"
                                            onclick="addEditTimeSlot()">Add Time Slot</button>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="course_code" class="form-label">Course <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control select2" id="course_code" name="course_code"
                                            required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="group_selection" class="form-label">Groups <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control select2" id="group_selection"
                                            name="group_selection[]" multiple required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label for="lecturer_ids" class="form-label">Lecturers <span
                                                class="text-danger">*</span></label>
                                        <select class="form-control select2" id="lecturer_ids" name="lecturer_ids[]"
                                            multiple required>
        ...
        <!-- Show Exam Modal -->
        <div class="modal fade" id="showExamModal" tabindex="-1" aria-labelledby="showExamModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
