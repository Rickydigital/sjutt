                                    ...
                                    <td rowspan="{{ $rowspan }}">
                                        @if($activities->isNotEmpty())
                                            <div class="tt-slot-stack">
                                                    ...
                                                    <div class="tt-course-card">
                                                        <div class="tt-course-top">
                                                            <div>
                                                                ...
                                                                <div class="tt-inline-note">{{ $activity->course_name ?? ($activity->course->name ?? 'N/A') }}</div>
                                                            </div>
                                                        ...
                                                        <div class="tt-course-meta">
                                                            ...
                                                            <div><strong>Assigned User:</strong> {{ $activity->lecturer->name ?? 'N/A' }}</div>
                                                            @if($isCross)
                                                        ...
                                                        <div class="tt-course-actions">
                                                            <a href="javascript:void(0)" class="tt-action show-timetable" data-id="{{ $activity->id }}" title="View Details">
                                                                <i class="bi bi-eye-fill"></i>
                                                            </a>

                                                            <a href="javascript:void(0)" class="tt-action edit-timetable" data-id="{{ $activity->id }}" title="Edit">
                                                            ...
                                                            <form action="{{ route('timetable.destroy', $activity->id) }}"
                                                                ...
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="tt-action tt-action-danger border-0 bg-transparent p-0" title="Delete">
                                                ...
                                                <div class="tt-add-inline add-timetable"
                                                     data-day="{{ $day }}"
                                                     data-time="{{ $slotStart }}"
                                        ...
                                        @else
                                            <div class="tt-empty-cell add-timetable"
                                                 data-day="{{ $day }}"
                                                 data-time="{{ $slotStart }}"
                                                 data-faculty="{{ $facultyId }}"
                                                 data-setup="{{ $timetableSemester?->id }}">
