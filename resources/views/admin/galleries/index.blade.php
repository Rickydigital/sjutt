...
@section('content')
    <div class="content">
        <div class="animated fadeIn">
            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('gallery.create') }}" class="btn btn-lg" style="background-color: #4B2E83; color: white; border-radius: 25px;">
                                            ...
                                            @foreach ($galleries as $gallery)
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <img src="{{ $gallery->media }}" alt="Media" width="100">
                                                    </td>
                                                    <td class="align-middle">
                                                        <a href="#" class="btn btn-sm btn-info action-btn" data-toggle="modal" 
                                                            data-target="#viewModal-{{ $gallery->id }}" title="View">
                                                            <i class="fa fa-eye"></i>
                                                        </a>
            ...
            <!-- Modals -->
            @foreach ($galleries as $gallery)
                <div class="modal fade" id="viewModal-{{ $gallery->id }}" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color: #4B2E83; color: white;">
                                <h5 class="modal-title">Gallery Item Details</h5>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">{{ $gallery->description }}</div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4"><strong>Media:</strong></div>
                                    <div class="col-md-8">
                                        <img src="{{ $gallery->media }}" alt="Media" class="img-fluid" style="max-width: 300px;">
                                    </div>
                                </div>
                            </div>
            ...
            @if ($galleries->hasPages())
                <div class="row mt-4">
                    <div class="col-md-12">
                        {{ $galleries->appends(['search' => request('search')])->links('pagination::bootstrap-4') }}
                    </div>
                </div>
            @endif
        </div>
