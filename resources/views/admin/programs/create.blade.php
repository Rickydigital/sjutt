                        ...
                        <div class="card-body">
                            <form action="{{ route('programs.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" required placeholder="e.g., Bachelor of Science in Information Technology">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="short_name" id="short_name" class="form-control" value="{{ old('short_name') }}" required placeholder="e.g., BScIT">
                                    @error('short_name')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_years" id="total_years" class="form-control" value="{{ old('total_years') }}" required min="1" max="10" placeholder="e.g., 3">
                                    @error('total_years')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <button type="submit" class="btn" style="background-color: #4B2E83; color: white;">Save Program</button>
                                </div>
                            </form>
                        </div>
                    </div>
