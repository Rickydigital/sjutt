                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('faculties.store') }}" method="POST" id="facultyForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_students_no" id="total_students_no"
                                        class="form-control" value="{{ old('total_students_no') }}" min="0" required>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button type="button" class="btn"
                                                style="background-color: #4B2E83; color: white;" data-toggle="modal"
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <button type="submit" class="btn"
                                        style="background-color: #4B2E83; color: white;">Save Faculty</button>
                                </div>
                            </form>
                            ...
                            <div class="modal fade" id="addCourseModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ route('faculties.storeCourse') }}" method="POST"
                                            id="addCourseForm">
                                            @csrf
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label for="course_code">Course Code <span
                                                ...
                                                <div class="form-group">
                                                    <label for="credits">Credits <span
                                                            class="text-danger">*</span></label>
                                                    <input type="number" name="credits" id="credits"
                                                        class="form-control" value="{{ old('credits') }}" min="1"
                                                        required>
                                                    @error('credits')
                                                        <small class="text-danger">{{ $message }}</small>
                                                    @enderror
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="lecturer_ids[]" id="lecturer_ids"
