                        ...
                        <li>
                            <div class="message-notif-scroll scrollbar-outer">
                                <div class="notif-center">
                                    <a href="#">
                                        <div class="notif-img">
                                            <img src="{{ asset('app-assets/img/jm_denis.jpg') }}"
                                                alt="Img Profile" />
                                        </div>
                                    ...
                                    <a href="#">
                                        <div class="notif-img">
                                            <img src="{{ asset('app-assets/img/chadengle.jpg') }}"
                                                alt="Img Profile" />
                                        </div>
                                        <div class="notif-content">
                                    ...
                                    <a href="#">
                                        <div class="notif-img">
                                            <img src="{{ asset('app-assets/img/mlane.jpg') }}"
                                                alt="Img Profile" />
                                        </div>
                                        <div class="notif-content">
                                    ...
                                    <a href="#">
                                        <div class="notif-img">
                                            <img src="{{ asset('app-assets/img/talha.jpg') }}"
                                                alt="Img Profile" />
                                        </div>
                                        <div class="notif-content">
                        ...
                        <li>
                            <div class="notif-scroll scrollbar-outer">
                                <div class="notif-center">
                                    ...
                                    <a href="#">
                                        <div class="notif-img">
                                            <img src="{{ asset('app-assets/img/profile2.jpg') }}"
                                                alt="Img Profile" />
                                        </div>
                                        <div class="notif-content">
                                            <span class="block">
                    ...
                    <div class="dropdown-menu quick-actions animated fadeIn">
                      ...
                      <li class="nav-item topbar-user dropdown hidden-caret">
                        ...
                        >
                            <div class="avatar-sm">
                                <img
                                    src="{{ asset('app-assets/img/user.png') }}"
                                    alt="User Profile"
                                ...
                                <li>
                                    <div class="user-box">
                                        <div class="u-text">
                                            ...
                                            <p class="text-muted"> <strong> {{ Auth::user()->getRoleNames()->first() ?? 'No Role' }}</strong></p>
                                        </div>
                                    </div>
                                </li>
                                <li>
