                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('venues.store') }}" method="POST" id="venueForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="longform" id="longform" class="form-control" value="{{ old('longform') }}" required placeholder="e.g., Main Lecture Hall">
                                    @error('longform')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" required placeholder="e.g., LH101">
                                    @error('name')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="lat" id="lat" class="form-control" value="{{ old('lat') }}" step="any" placeholder="e.g., 40.7128">
                                    @error('lat')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="lng" id="lng" class="form-control" value="{{ old('lng') }}" step="any" placeholder="e.g., -74.0060">
                                    @error('lng')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="form-group text-right">
                                    ...
                                    <button type="submit" class="btn" style="background-color: #4B2E83; color: white;">Save Venue</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('.select2').select2({
                ...
                allowClear: false // Prevent clearing to ensure required field
            });

            // Ensure building_id is sent
